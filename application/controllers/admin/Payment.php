...
class Payment extends Home_Controller {
    ...
    public function update(){
            ...
            if(!empty($this->input->post('youcanpay'))){$youcanpay = $this->input->post('youcanpay', true);}
            else{$youcanpay = 0;}
            ...
            $data = array(
                ...
                'youcan_mode' => $this->input->post('youcan_mode', true),
                ...
                'youcansandboxPublicKey'=> $this->input->post('youcansandboxPublicKey', true),
                'youcansandboxPrivateKey'=> $this->input->post('youcansandboxPrivateKey', true),
                'youcanPublicKey'=> $this->input->post('youcanPublicKey', true),
                'youcanPrivateKey'=> $this->input->post('youcanPrivateKey', true),
