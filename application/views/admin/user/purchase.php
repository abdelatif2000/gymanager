                        ...
                        <div class="tabbable-panel mt-20">
                            <div class="tabbable-line">
                                <ul class="nav nav-pills mb-3 mt-5 justify-content-center" id="pills-tab" role="tablist">
                                    ...
                                    <?php endif ?>
                                    <!-- youCanPay : -->
                                    <?php if (settings()->youcanpay == 1): ?>
                                    <li class="nav-item pi">
                                        <a class="nav-link" data-toggle="tab" href="#tab_default_6"><img width="70px" src="<?php echo base_url() ?>assets/admin/payment/youcan.svg"/></a>
                                    </li>
                                    <?php endif ?>
                                    <!-- end youCanPay -->
                                        ...
                                        <div class="tab-pane text-center" id="tab_default_6">
                                           <div class="row">
                                                <div class="box col-md-8 m-auto">
                                                    <div class="box-body text-center">
                                                        <div class="payment_content text-center">
                                                            <h3 class="text-center">YouCanPay <?php echo trans('payment-upgrade-plan') ?></h3>
                                                            <h4 class="mb-20 text-center"><?php echo trans('plan') ?>: <?php echo html_escape($package->name);?> (<strong><?php echo html_escape($settings->currency_symbol); ?><?php echo html_escape($price) ?> <?php echo html_escape($frequency) ?></strong>)</h4><br>
                                                            <a href="<?= $youCanPayUrl; ?>" class="btn btn-primary btn-md"><?php echo trans('pay-now') ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
