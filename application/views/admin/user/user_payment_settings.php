                ...
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block">
                      ...
                      <span class="pull-right"><input type="checkbox" name="youcanpay" value="1" <?php if (user()->youcanpay == 1) {
                                                                                                    echo 'checked';
                  ...
                  <div class="box-body minh-200">
                    <div class="form-group">
                      ...
                      <div class="">
                        <select class="form-control" id="youcan_mode" name="youcan_mode">
                          <option value="sandbox" <?php echo (user()->youcan_mode == 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                          <option value="live" <?php echo (user()->youcan_mode == 'live') ? 'selected' : ''; ?>>Live</option>
                        </select>
                      </div>
                    </div>
                    <div id="youcan-live">
                      <div class="form-group">
                        ...
                        <div class="">
                          <input type="text" name="youcanPublicKey" value="<?php echo html_escape(user()->youcanPublicKey); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Private key</label>
                        <div class="">
                          <input type="text" name="youcanPrivateKey" value="<?php echo html_escape(user()->youcanPrivateKey); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div id="youcan-sandBox">
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Public Key</label>
                        <div class="">
                          <input type="text" name="youcansandboxPublicKey" value="<?php echo html_escape(user()->youcansandboxPublicKey); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Private key</label>
                        <div class="">
                          <input type="text" name="youcansandboxPrivateKey" value="<?php echo html_escape(user()->youcansandboxPrivateKey); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
