<div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block">
                      ...
                      <span class="pull-right"><input type="checkbox" name="paypal_payment" value="1" <?php if (settings()->paypal_payment == 1) {
                                                                                                        echo 'checked';
                                                                                                      } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span>
                    </h3>
                  </div>
              ...
              <div class="col-sm-6">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block">
                      <img width="100px" src="<?php echo base_url() ?>assets/admin/payment/youcan.svg" />
                      <span class="pull-right"><input type="checkbox" name="youcanpay" value="1" <?php if (settings()->youcanpay == 1) {
                                                                                                    echo 'checked';
                                                                                                  } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span>
                    </h3>
                  </div>
                  <div class="box-body minh-200">
                    <div class="form-group">
                      <label class=" control-label" for="example-input-normal"><?php echo trans('mode') ?> </label>
                      <div class="">
                        <select class="form-control" id="youcan_mode" name="youcan_mode">
                          <option value="sandbox" <?php echo (settings()->youcan_mode == 'sandbox') ? 'selected' : ''; ?>>Sandbox</option>
                          <option value="live" <?php echo (settings()->youcan_mode == 'live') ? 'selected' : ''; ?>>Live</option>
                        </select>
                      </div>
                    </div>
                    <div id="youcan-live">
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Public Key</label>
                        <div class="">
                          <input type="text" name="youcanPublicKey" value="<?php echo html_escape(settings()->youcanPublicKey); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Private key</label>
                        <div class="">
                          <input type="text" name="youcanPrivateKey" value="<?php echo html_escape(settings()->youcanPrivateKey); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div id="youcan-sandBox">
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Public Key</label>
                        <div class="">
                          <input type="text" name="youcansandboxPublicKey" value="<?php echo html_escape(settings()->youcansandboxPublicKey); ?>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class=" control-label" for="example-input-normal">Private key</label>
                        <div class="">
                          <input type="text" name="youcansandboxPrivateKey" value="<?php echo html_escape(settings()->youcansandboxPrivateKey); ?>" class="form-control">
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-sm-6">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block"><img width="80px" src="<?php echo base_url() ?>assets/admin/payment/stripe.svg" /> <span class="pull-right"><input type="checkbox" name="stripe_payment" value="1" <?php if (settings()->stripe_payment == 1) {
                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                      } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                  </div>
              ...
              <div class="col-sm-6">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block"><img width="100px" src="<?php echo base_url() ?>assets/admin/payment/razorpay.svg" /> <span class="pull-right"><input type="checkbox" name="razorpay_payment" value="1" <?php if (settings()->razorpay_payment == 1) {
                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                          } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                  </div>
              ...
              <div class="col-sm-6">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block"><img width="100px" src="<?php echo base_url() ?>assets/admin/payment/paystack.svg" /> <span class="pull-right"><input type="checkbox" name="paystack_payment" value="1" <?php if (settings()->paystack_payment == 1) {
                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                          } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                  </div>
              ...
              <div class="col-sm-6">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title d-block"><img width="100px" src="<?php echo base_url() ?>assets/admin/payment/mercado_pago.svg" /> <span class="pull-right"><input type="checkbox" name="mercado_payment" value="1" <?php if (settings()->mercado_payment == 1) {
                                                                                                                                                                                                                                echo 'checked';
                                                                                                                                                                                                                              } ?> data-toggle="toggle" data-onstyle="primary" data-width="80"></span></h3>
                  </div>
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <select name="mercado_currency" class="form-control">
                            <option value="BRL" <?php if (settings()->mercado_currency == 'BRL') {
                                                  echo "selected";
                                                } ?>>BRL&nbsp;(Brazil Real)</option>
                            <option value="ARS" <?php if (settings()->mercado_currency == 'ARS') {
                                                  echo "selected";
  ...
  <script>
    $(function() {
      ...
      showHideElement(selectValue);
      // When the value of the select element changes
      $('#youcan_mode').change(function() {
        // Get the value of the select element
        var selectValue = $(this).val();
        showHideElement(selectValue);
      });

      function showHideElement(selectValue) {
        // If the value is "option1"
        if (selectValue === 'live') {
          // Show the element
          $('#youcan-live').show();
          $('#youcan-sandBox').hide();
        }
        // Otherwise (if the value is not "sandbox")
        else {
          // Hide the element
          $('#youcan-live').hide();
          $('#youcan-sandBox').show();
